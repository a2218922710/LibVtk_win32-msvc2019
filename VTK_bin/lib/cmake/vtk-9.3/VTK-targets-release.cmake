...
set_target_properties(VTK::GUISupportQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-9.3.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQt )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQt "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-9.3.dll" )
...
set_target_properties(VTK::ViewsQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.3.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::ViewsQt )
list(APPEND _cmake_import_check_files_for_VTK::ViewsQt "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.3.dll" )
...
set_target_properties(VTK::RenderingQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.3.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::RenderingQt )
list(APPEND _cmake_import_check_files_for_VTK::RenderingQt "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.3.dll" )
...
set_target_properties(VTK::GUISupportQtSQL PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::vtksys"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtSQL )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtSQL "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.3.dll" )
...
set_target_properties(VTK::GUISupportQtQuick PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQtQuick-9.3.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQtQuick-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtQuick )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtQuick "${_IMPORT_PREFIX}/lib/vtkGUISupportQtQuick-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtQuick-9.3.dll" )
...
set_target_properties(VTK::qmlvtkplugin PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qml/Release/VTK.9.3/qmlvtkplugin.dll"
  )

list(APPEND _cmake_import_check_targets VTK::qmlvtkplugin )
list(APPEND _cmake_import_check_files_for_VTK::qmlvtkplugin "${_IMPORT_PREFIX}/lib/qml/Release/VTK.9.3/qmlvtkplugin.dll" )
